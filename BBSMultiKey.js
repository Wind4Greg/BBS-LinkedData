...
let myBytes = new Uint8Array(varint.encode(0xeb));
...
let BBSG2Prefix = new Uint8Array(varint.encode(0xeb)); // Need to use varint on the multicodecs code
let pubBBSEncoded = base58btc.encode(concatBytes(BBSG2Prefix, publicKey));
